(function () {
	angular.module('notinphillyServerApp')
	  .controller('ExploreMapController', [ '$scope', '$routeParams', '$rootScope', 'resolveParams', 'mapService', 'APP_EVENTS', 'APP_CONSTS', 
	  function($scope, $routeParams, $rootScope, resolveParams, mapService, APP_EVENTS, APP_CONSTS) 
	  {
		switch(resolveParams.mapView())
		{
