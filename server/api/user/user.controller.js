...
var sendConfirmationEmail = function(req, user) {
  var data = {
    ...
    text: "Hi " + req.body.firstName + ", Just a reminder that we are testing this project in the Walnut Hill neighborhood right now. Sign up wherever you live and we'll let you know when we expand to your neighborhood! \n\n Please follow the link in order to finish the registration: \n http://notinphilly.org/api/users/confirm/" + user.activationHash + "\n \n \n #NotInPhilly Team"
  };
